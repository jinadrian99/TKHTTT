...
class project(osv.osv):
    ...
    _columns = {
        'my_note': fields.text('My Note', size=200, required=True, translate=False),
        'project_category': fields.selection([('0', "Contact's suggestion"),('1','Feature request'),('2','Experiment'),('3','Usability'),('4','Create and Edit...')], 'Project Category', select=True),
        'starting_date': fields.date('Starting Date', size=50),
        'project_status': fields.selection([('0','Active'),('1','Pending'),('2','Completed')], 'Project Status', select=True),
        'project_location':fields.char('Project Location', size=50, required=True, translate=False),
